...
export default new Command({
  ...
  options: [
      ...
      options: [
        {
          name: "channel",
          description:
            "The channel where the welcome cards are going to be sent",
    ...
    },
    {
      name: "text",
      description:
        "Change what's the text that's going to be sent along with the card",
      type: ApplicationCommandOptionType.Subcommand,
      options: [
        {
          name: "text",
          description:
            "The text that's going to be sent. Available placeholders: {member}, {guild}",
      ...
      return interaction.reply({
        ...
        embeds: [
          new ExtendedEmbed()
            ...
            .setDescription(
              `The welcome channel has been successfully set to ${channel}.`
            ),
        ],
      });
      ...
      return interaction.reply({
        ...
        embeds: [
          new ExtendedEmbed()
            .setTitle("Operation Successful")
            .setDescription(
              `The welcome channel has been successfully disabled.`
            ),
        ],
      });
    } else if (query === "text") {
      ...
      return interaction.reply({
        ...
        embeds: [
          new ExtendedEmbed()
            .setTitle("Operation Successful")
            .setDescription(
              `The welcome channel text has been successfully changed.`
            )
            .addFields([
              {
                name: "Text",
