...
export default new Command({
    ...
    run: async ({ client, interaction, args }) => {
        ...
        if (((giveawayChannel): giveawayChannel is TextChannel => giveawayChannel.type === ChannelType.GuildText || giveawayChannel.type === ChannelType.GuildNews)(giveawayChannel)) {
