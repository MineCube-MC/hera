...
export const command: Command = {
    ...
    options: [
        {
            name: 'create',
            description: 'Create a new partnership in the support server (bot owners only!)',
            type: 'SUB_COMMAND',
            options: [
                {
                    name: 'description',
        ...
        {
            name: 'remove',
            description: 'Remove an existing partnership (bot owners only!)',
            type: 'SUB_COMMAND',
            options: [
                {
                    name: 'guild',
        ...
        {
            name: 'sponsor',
            description: 'Send a sponsor message in the current channel',
            type: 'SUB_COMMAND',
            options: [
                {
                    name: 'title',
